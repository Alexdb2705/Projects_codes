...
dataset = CustomDataset(
    npy_dir=f"/Datasets/Reorganized/Classification_300",
    labels_file=f"/Datasets/Reorganized/labels_vector_300.npy"
)
...
torch.save(model.state_dict(), f"/Models/npy_classifier_1800samples_100epochs_32bs.pth")
